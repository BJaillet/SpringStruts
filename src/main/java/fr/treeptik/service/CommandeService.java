...
//		
//		return articleService.listAllLivres();
//	}
	
	@Transactional
	public void addArticle(Commande commande, Article article) throws ServiceException {
		try {
			commandeDAO.addArticle(commande, article);
		} catch (DAOException e) {
			throw new ServiceException("", e);
		}
	}
...
//	@Transactional
//	public List listArticles(Commande commande) throws ServiceException {
//		try {
//			commandeDAO.addArticle(commande, article);
//		} catch (DAOException e) {
//			throw new ServiceException("", e);
